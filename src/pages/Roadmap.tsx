              ...
              <div className="w-full max-w-xl space-y-6">
                <div className="bg-card border border-border rounded-2xl p-4 shadow-sm space-y-4">
                  <div className="text-left space-y-2">
                    <label className="text-sm font-medium text-muted-foreground px-1">What can I help you learn?</label>
                  ...
                  {generateType === "guide" && (
                    <div className="flex items-center justify-between px-1 pt-2">
                      ...
                      <button onClick={() => setShowApiSettings(true)} className="text-xs flex items-center gap-1 text-muted-foreground hover:text-foreground transition-colors">
